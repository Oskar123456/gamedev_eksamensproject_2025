...
namespace Player
{
    ...
    public class PlayerScriptWarrior : MonoBehaviour
    {
        PlayerStats stats;
        ...
        void Start()
        {
            ...
            wizard_renderer = GameObject.Find("Body05").GetComponent<Renderer>();
        ...
        void ChooseAnimation()
        {
            ...
            if (hit_time_left > 0) {
                ...
                if (d_y < 0 && fall_time > 0.2f) { animator.Play("JumpFull_Normal_RM_SwordAndShield"); }
                else if (d_y > 0 && fall_time < 0.3f) { animator.Play("JumpFull_Normal_RM_SwordAndShield"); }
                else if (d_y > 0) { animator.Play("JumpFull_Normal_RM_SwordAndShield"); }
            }
